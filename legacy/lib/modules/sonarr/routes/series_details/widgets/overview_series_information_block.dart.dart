  ...
  Widget build(BuildContext context) {
    return LunaTableCard(
      content: [
        ...
        LunaTableContent(title: 'type', body: series?.lunaSeriesType),
        LunaTableContent(title: 'path', body: series?.path),
        LunaTableContent(title: 'quality', body: qualityProfile?.name),
        LunaTableContent(title: 'language', body: languageProfile?.name),
        LunaTableContent(title: 'tags', body: series?.lunaTags(tags)),
        LunaTableContent(title: '', body: ''),
        LunaTableContent(title: 'status', body: series?.status?.toTitleCase()),
        LunaTableContent(title: 'next airing', body: series?.lunaNextAiring()),
        LunaTableContent(title: 'added on', body: series?.lunaDateAdded),
        LunaTableContent(title: '', body: ''),
        LunaTableContent(title: 'year', body: series?.lunaYear),
        LunaTableContent(title: 'network', body: series?.lunaNetwork),
        LunaTableContent(title: 'runtime', body: series?.lunaRuntime),
        LunaTableContent(title: 'rating', body: series?.certification),
        LunaTableContent(title: 'genres', body: series?.lunaGenres),
        LunaTableContent(
