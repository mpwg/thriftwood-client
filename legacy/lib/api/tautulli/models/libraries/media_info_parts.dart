...
class TautulliMediaInfoParts {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'video_streams': TautulliMediaInfoParts._videoStreamToMap(
      this.videoStreams!,
    ),
    'audio_streams': TautulliMediaInfoParts._audioStreamToMap(
      this.audioStreams!,
    ),
    'subtitle_streams': TautulliMediaInfoParts._subtitleStreamToMap(
      this.subtitleStreams!,
    ),
  };
