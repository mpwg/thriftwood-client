...
class TautulliCommandHandlerSystem {
  ...
  /// Handler for [backup_config](https://github.com/Tautulli/Tautulli/blob/main/API.md#backup_config).
  ///
  /// Create a manual backup of the `config.ini` file.
  Future<void> backupConfig() async => _commandBackupConfig(_client);

  /// Handler for [backup_db](https://github.com/Tautulli/Tautulli/blob/main/API.md#backup_db).
  ///
  /// Create a manual backup of the `plexpy.db` file.
  Future<void> backupDB() async => _commandBackupDB(_client);

  /// Handler for [delete_cache](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_cache).
  ///
  /// Delete and recreate the cache directory.
  Future<void> deleteCache() async => _commandDeleteCache(_client);

  /// Handler for [delete_hosted_images](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_hosted_images).
  ///
  ...
  /// Handler for [delete_image_cache](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_image_cache).
  ///
  /// Delete and recreate the image cache directory.
  Future<void> deleteImageCache() async => _commandDeleteImageCache(_client);

  /// Handler for [delete_login_log](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_login_log).
  ///
  /// Delete the Tautulli login logs.
  Future<void> deleteLoginLog() async => _commandDeleteLoginLog(_client);

  /// Handler for [delete_lookup_info](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_lookup_info).
  ///
  ...
  /// Handler for [delete_media_info_cache](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_media_info_cache).
  ///
  ...
  /// Handler for [delete_newsletter_log](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_newsletter_log).
  ///
  /// Delete the Tautulli newsletter logs.
  Future<void> deleteNewsletterLog() async =>
      _commandDeleteNewsletterLog(_client);

  /// Handler for [delete_notification_log](https://github.com/Tautulli/Tautulli/blob/main/API.md#delete_notification_log).
  ///
  /// Delete the Tautulli notification logs.
  Future<void> deleteNotificationLog() async =>
      _commandDeleteNotificationLog(_client);

  /// Handler for [get_pms_token](https://github.com/Tautulli/Tautulli/blob/main/API.md#get_pms_token).
  ///
  ...
  /// Handler for [get_pms_update](https://github.com/Tautulli/Tautulli/blob/main/API.md#get_pms_update).
  ///
  /// Check for updates to the Plex Media Server.
  Future<TautulliPMSUpdate> getPMSUpdate() async =>
      _commandGetPMSUpdate(_client);

  /// Handler for [get_settings](https://github.com/Tautulli/Tautulli/blob/main/API.md#get_settings).
  ///
  ...
  /// Handler for [restart](https://github.com/Tautulli/Tautulli/blob/main/API.md#restart).
  ///
  /// Restart Tautulli.
  Future<void> restart() async => _commandRestart(_client);

  /// Handler for [status](https://github.com/Tautulli/Tautulli/blob/main/API.md#status).
  ///
  /// Get the current status of Tautulli.
  Future<String?> status() async => _commandStatus(_client);

  /// Handler for [update](https://github.com/Tautulli/Tautulli/blob/main/API.md#update).
  ///
  /// Update Tautulli.
  Future<void> update() async => _commandUpdate(_client);

  /// Handler for [update_check](https://github.com/Tautulli/Tautulli/blob/main/API.md#update_check).
  ///
