...
class SonarrQualityProfileItemQuality {
  ...
  factory SonarrQualityProfileItemQuality.fromJson(Map<String, dynamic> json) =>
      _$SonarrQualityProfileItemQualityFromJson(json);

  /// Serialize a [SonarrQualityProfileItemQuality] object to a JSON map.
  Map<String, dynamic> toJson() =>
      _$SonarrQualityProfileItemQualityToJson(this);
}
