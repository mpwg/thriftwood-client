...
open class RadarrAPIAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "http://http://localhost:7878",
    ...
    public static let shared = RadarrAPIAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: RadarrAPIAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: RadarrAPIAPIConfiguration = RadarrAPIAPIConfiguration.shared) {
        self.method = method
