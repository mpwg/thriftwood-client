...
public struct DownloadClientResource: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var presets: [DownloadClientResource]?
    ...
    public init(id: Int? = nil, name: String? = nil, fields: [Field]? = nil, implementationName: String? = nil, implementation: String? = nil, configContract: String? = nil, infoLink: String? = nil, message: ProviderMessage? = nil, tags: Set<Int>? = nil, presets: [DownloadClientResource]? = nil, enable: Bool? = nil, _protocol: DownloadProtocol? = nil, priority: Int? = nil, removeCompletedDownloads: Bool? = nil, removeFailedDownloads: Bool? = nil) {
        self.id = id
        self.name = name
        self.fields = fields
...
extension DownloadClientResource: Identifiable {}
